						...
						<div class="col-xs-6 col-sm-3">
							<div class="small-box bg-yellow">
					            <div class="inner text-center">
					              ...
					              <i class="fas fa-money-bill-alt"></i> @lang('sale.total'): <span class="display_currency" data-currency_symbol=true>{{ app(\App\Utils\Util::class)->adjustSaleDisplayAmount($sale->final_total) }}</span>
					              </p>

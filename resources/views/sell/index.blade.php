            ...
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number summary_sales_count">0</span>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number summary_total_sales">0</span>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="info-box">
                    <span class="info-box-icon bg-yellow"><i class="fas fa-wallet"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">@lang('sale.total_paid')</span>
                        <span class="info-box-number summary_total_paid">0</span>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number summary_total_remaining">0</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function() {
            function getAllSalesFilters() {
                ...
                if ($('#shipping_status').length) {
                    filters.shipping_status = $('#shipping_status').val();
                }

                if ($('#only_subscriptions').length && $('#only_subscriptions').is(':checked')) {
                    filters.only_subscriptions = 1;
                }

                return filters;
            }

            function loadAllSalesSummary() {
                $.ajax({
                    url: '/sells',
                    dataType: 'json',
                    data: $.extend({}, getAllSalesFilters(), { summary_only: 1 }),
                    success: function(data) {
                        $('.summary_sales_count').text(data.sales_count || 0);
                        $('.summary_total_sales').html(__currency_trans_from_en(data.total_sales || 0));
                        $('.summary_total_paid').html(__currency_trans_from_en(data.total_paid || 0));
                        $('.summary_total_remaining').html(__currency_trans_from_en(data.total_remaining || 0));
                    },
                });
            }

            function reloadAllSales() {
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'additional_notes', name: 'additional_notes', visible: false, createdCell: function(td) { $(td).css('display', 'none'); } },
                    { data: 'staff_note', name: 'staff_note', visible: false, createdCell: function(td) { $(td).css('display', 'none'); } },
                    { data: 'shipping_details', name: 'shipping_details', visible: false, createdCell: function(td) { $(td).css('display', 'none'); } },
            ...
            $('#sell_table').on('search.dt order.dt page.dt', function() {
                loadAllSalesSummary();
            });
        });
    </script>
